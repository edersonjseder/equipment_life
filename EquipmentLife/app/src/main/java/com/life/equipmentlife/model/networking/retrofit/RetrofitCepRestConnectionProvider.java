...
public class RetrofitCepRestConnectionProvider {
    ...
    public RetrofitCepRestConnectionProvider(Context context) {
        mContext = context;
    ...
    public CepApi getCepApi() {
        ...
        if (mCepApi == null) {
            ...
            mCepApi = getRetrofit().create(CepApi.class);
    ...
    private Retrofit getRetrofit() {
        ...
        if (mRetrofit == null) {
            ...
            mRetrofit = new Retrofit.Builder().baseUrl(URL_CEP)
